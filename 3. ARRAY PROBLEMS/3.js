...
// Now I had managed to find the '%n' logic and the drop logic (by the help of gemini). But I struggled to connect them both as I didnt see that it was necessary that i had to connect last and first index as well (for comparision) using '%n' because the array's rotated.
